...
foreach ($products as $index => $item) {
    ...
    // Color dropdown placeholder (populated via JS)
    echo "<td>
...
?>
    ...
    const productData = {
        ...
        product_2: { sizes: ["S", "M", "L"], colors: ["Red", "Blue"], qty: 20, price: 15 },
        product_3: { sizes: ["XS", "S", "M"], colors: ["White", "Pink"], qty: 40, price: 12 },
    ...
    function updateColors(productId) {
        ...
        // Populate colors based on selected size
